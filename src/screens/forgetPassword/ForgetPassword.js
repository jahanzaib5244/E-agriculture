...
export default function ForgetPassword({navigation}) {
  ...
  return (
    <ScrollView
      contentContainerStyle={ForgetPasswordStyle.root}
      showsVerticalScrollIndicator={false}>
      <View style={ForgetPasswordStyle.uppercontainer}>
        <TouchableOpacity
          style={ForgetPasswordStyle.back}
        ...
        <Text style={ForgetPasswordStyle.singupText}>
          ...
          <Formik
            ...
            {({
              ...
              <>
                ...
                />
                {!!touched.Email && (
                  <Text style={ForgetPasswordStyle.error}>{errors.Email}</Text>
                )}
                {!!isinvalid && (
                  <Text style={ForgetPasswordStyle.error}>{isinvalid}</Text>
                )}
                <View style={ForgetPasswordStyle.btnContainer}>
                  {loading ? (
                    ...
                    <AppButton
                      ...
                      name={strings.forgetPassword}
                      BTstyle={ForgetPasswordStyle.btn}
                    />
                  )}
                </View>
              </>
